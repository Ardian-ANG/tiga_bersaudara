...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="/template/admin/assets/images/favicon.png">
    <title>Halaman Admin</title>
    <!-- Custom CSS -->
    <!-- <link href="/template/admin/assets/libs/fullcalendar/dist/fullcalendar.min.css" rel="stylesheet" /> -->
    <link rel="stylesheet" href="sweetallert/dist/sweetalert2.css">
...
<body>
            ...
            <div class="scroll-sidebar" data-sidebarbg="skin6">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link" href="/kategori" aria-expanded="false"><i data-feather="tag" class="feather-icon"></i><span class="hide-menu">kategori
                                </span></a>
                        </li>
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link has-arrow" href="javascript:void(0)" aria-expanded="false"><i data-feather="file-text" class="feather-icon"></i><span class="hide-menu">Forms </span></a>
                            <ul aria-expanded="false" class="collapse  first-level base-level-line">
                                ...
                                <li class="sidebar-item"><a href="form-input-grid.html" class="sidebar-link"><span class="hide-menu"> Produk-Produk
                                        </span></a>
                                </li>
    ...
    <script src="/template/admin/assets/extra-libs/taskboard/js/jquery.ui.touch-punch-improved.js"></script>
    <script src="/template/admin/assets/extra-libs/taskboard/js/jquery-ui.min.js"></script>
    <script src="/template/admin/assets/libs/popper.js/dist/umd/popper.min.js"></script>
    <script src="/template/admin/assets/libs/bootstrap/dist/js/bootstrap.min.js"></script>
    <!-- apps -->
    <script src="/template/admin/dist/js/app-style-switcher.js"></script>
    <script src="/template/admin/dist/js/feather.min.js"></script>
    <script src="/template/admin/assets/libs/perfect-scrollbar/dist/perfect-scrollbar.jquery.min.js"></script>
    <script src="/template/admin/dist/js/sidebarmenu.js"></script>
    <!--Custom JavaScript -->
    <script src="/template/admin/dist/js/custom.min.js"></script>
