...
<div class="row">
    <div class="col-md-12">
        <div class="card">
            <h2 class="my-3 ml-4">Form Tambah Data Produk</h2>
            ...
            <form action="/produk/save" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-2">
                        <img src="/gambar/default.jpg" class=" col-sm-12 img-thumnail img-preview">
                    </div>
                    <div class="col-sm-7">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input type="int" class="form-control <?= ($validation->hasError('harga')) ? 'is-invalid' : ''; ?>" id="harga" name="harga" value="<?= old('harga'); ?>">
                        <div class="invalid-feedback">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control <?= ($validation->hasError('estimasi_waktu')) ? 'is-invalid' : ''; ?>" id="estimasi_waktu" name="estimasi_waktu" value="<?= old('estimasi_waktu'); ?>">
                        <div class="invalid-feedback">
                ...
                <div class="form-group row">
                    <div class="col-sm-10">
                        <button type="submit" class="btn btn-primary ml-4">Tambah Produk</button>
                    </div>
                </div>
            </form>
        </div>
